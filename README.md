# 📅 CampusMate - 校園王 (v5.9.1)

**校園王 (CampusMate)** 是一個專為學生設計的 Web OS 風格個人化校園生活管理助手 (PWA)。
整合課表、成績、記帳、學習進度與社群討論，透過雲端同步，讓你在任何裝置上都能輕鬆管理校園生活。

[![GitHub Repo stars](https://img.shields.io/github/stars/yourusername/campusmate?style=social)]()
![Version](https://img.shields.io/badge/version-5.9.1-blue.svg) ![Firebase](https://img.shields.io/badge/database-Firebase-orange.svg) ![PWA](https://img.shields.io/badge/PWA-Supported-green.svg)
...
* **SPA 單頁應用**：深度整合 History API，切換功能不刷新頁面，並支援瀏覽器「上一頁/下一頁」導航。
* **深色模式 (Dark Mode)**：內建淺色/深色主題切換，夜晚使用更護眼。
* **PWA 支援**：支援安裝至手機主畫面，並具備離線快取能力 (Service Worker)。
...
* **管理功能**：作者可編輯或刪除自己的文章，系統管理員擁有全域管理權限。
